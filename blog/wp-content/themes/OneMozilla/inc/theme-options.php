...
function onemozilla_color_schemes() {
	$color_scheme_options = array(
		...
		'redcol' => array(
			'value' => 'redcol',
			'label' => __( 'Redcol', 'onemozilla' ),
			'thumbnail' => get_template_directory_uri() . '/colors/redcol/redcol.jpg',
		),
	);
...
function onemozilla_enqueue_color_scheme() {
	...
	if ( 'redcol' == $color_scheme )
		wp_enqueue_style( 'redcol', get_template_directory_uri() . '/colors/redcol/redcol.css', array(), null );
